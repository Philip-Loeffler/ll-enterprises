          ...
          <div className="max-w-xl bg-white/95 backdrop-blur-sm p-8 sm:p-12 rounded-2xl shadow-2xl">
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <p>
                ...
                professionalism and reliability. What began as general
                contracting home building focus evolved into a full-time
                electrical services business specializing in construction,
                service, and repair focused on getting the job done right the
                first time.
              </p>

              <p>
                Customers appreciate Loveland Enterprises' personalized care —
                the kind that only comes from a small business built on
                integrity and accountability.
              </p>

              <p>
                Beyond the trade, Rick is a proud father of three and, above
                all, a grateful grandfather to two beautiful granddaughters —
                his favorite title of all. Guided by faith, family, and a deep
                love for his community, he approaches every project as more than
                just a job — it's an opportunity to serve, to help, and to make
                a difference.
              </p>
